  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <Image
            src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/about-us.svg`}
            alt="Beaters"
            width={500}
            height={60}
            style={{
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div style={{}}>
                <img
                  src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/office-1.svg`}
                  alt="office 1"
                  style={{
                    backgroundPosition: "center",
                  }}
              ...
              >
                ...
                >
                  <div>
                    <Image
                      src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/map-icon.svg`}
                      alt="Beaters"
                      width={10}
                      height={40}
                      style={{
        ...
        >
          <Image
            src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/office-locations-banner.svg`}
            alt="Beaters"
            width={300}
            height={40}
            style={{
      ...
      <div
        style={{
          ...
          background: "#00070D",
          padding: "50px 50px 50px 50px",
          background: `url("${process.env.NEXT_PUBLIC_BASE_PATH}/assets/careers-bg.svg")`,
          backgroundPosition: "center",
          backgroundSize: "cover",
        }}
      >
          ...
          >
            ...
            >
              ...
              >
                <div>
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/experience-icon.svg`}
                    alt="Beaters"
                    width={15}
                    height={40}
                    style={{
              ...
              >
                <div>
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/location-icon.svg`}
                    alt="Beaters"
                    width={15}
                    height={40}
                    style={{
              ...
              >
                <div>
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/user-icon.svg`}
                    alt="Beaters"
                    width={15}
                    height={40}
                    style={{
              ...
              >
                ...
                >
                  Apply
                  <Image
                    src={`${process.env.NEXT_PUBLIC_BASE_PATH}/assets/send-arrow-icon.svg`}
                    alt="Beaters"
                    width={15}
                    height={40}
                    style={{
